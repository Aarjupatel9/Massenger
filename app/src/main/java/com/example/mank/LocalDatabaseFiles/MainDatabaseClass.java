...
@Database(entities = {MassegeEntity.class, loginDetailsEntity.class, ContactWithMassengerEntity.class , SetupFirstTimeEntity.class, AllContactOfUserEntity.class}, version = 6)
